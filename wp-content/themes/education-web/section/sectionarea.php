    ...
    function education_web_slider_section()
    {
        ...
        if (get_theme_mod('education_web_slider_options', 1) == 1) {
            ...
            if (!empty($all_slider)) { ?>
                                ...
                                if ($slider_page->have_posts()) {
                                    while ($slider_page->have_posts()) {
                                        ...
                                        <div class="single-slider"
                                             style="background-image:url(<?php echo esc_url($image_path[0]); ?>)">
                                            <div class="edu-overlay"></div>
                                            <div class="container">
                                                <div class="row">
                                                    <div class="col-md-7 col-sm-12 <?php if ($count % 2 != 0) {
                                                        echo esc_attr('col-md-offset-5');
                                                    } ?> col-xs-12">
                                                        <div class="slide-text <?php if ($count % 2 != 0) {
                                                            echo esc_attr('right');
                                                        } ?>">
                                                            <h2><?php the_title(); ?></h2>
                                                            ...
                                                            <?php if ($slider->button_text || $slider->button_url) { ?>
                                                                <div class="slide-btn">
                                                                    <a href="<?php echo esc_url($slider->button_url); ?>"
                                                                       class="btn primary">
                                                                        <?php echo esc_attr($slider->button_text); ?><i
                                                                                class="fa fa-play"></i>
                                                                    </a>
                                                                </div>
                                                            <?php } ?>
                ...
                <section class="blog-main hs-section">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="section-title">
                                    <h2>Соціальна робота</h2>
                                </div>
                                <?= $social = get_field('mission'); ?>
                            </div>
                        </div>
                    </div>
                </section>
        ...
        if (get_theme_mod('education_web_services_area_options', 1) == 1) {
            ...
            if (!empty($featuresservices)) { ?>
                ...
                <section class="features hs-section <?php echo esc_attr($flayout); ?>">
                    <div class="<?php if ($fscontainer == 'layout2') {
                        ...
                        <div class="row">
                            ...
                            foreach ($allfeaturesservices as $fservices) {
                                ...
                                if (!empty($page_id)) {
                                    ...
                                    if ($servicespage->have_posts()) {
                                        while ($servicespage->have_posts()) {
                                            $servicespage->the_post();
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-7 col-sm-12 col-xs-12">
                                ...
                                if ($skillabout->have_posts()) {
                                    while ($skillabout->have_posts()) {
                                        $skillabout->the_post();
                                        ?>
                                        ...
                                        <div class="single-skill">
                                            ...
                                            <div class="progress">
                                                <div class="progress-bar" role="progressbar"
                                                     aria-valuenow="<?php echo intval($skill->counter_number); ?>"
                                                     aria-valuemin="0" aria-valuemax="100"
                                                     style="width: <?php echo intval($skill->counter_number); ?>%;">
                                                    <span class="percent"><?php echo intval($skill->counter_number); ?>%</span>
                                                </div>
                                            </div>
                                        </div>
                                    <?php }
                        ...
                        <div class="row">
                            ...
                            foreach ($allacademics as $academics) {
                                ...
                                if (!empty($page_id)) {
                                    ...
                                    if ($academic->have_posts()) {
                                        while ($academic->have_posts()) {
                                            $academic->the_post();
                                            ?>
                                            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                                <div class="academics-item">
                                                    ...
                                                    <div class="edu-text">
                                                        <h3><?php the_title(); ?></h3>
                                                        <p><?php echo esc_attr(wp_trim_words(get_the_content(), $desclimit)); ?></p>
                                                        <a class="btn btn-rm btn-common"
                                                           href="<?php the_permalink(); ?>"><?php esc_html_e('Explore', 'education-web'); ?></a>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <?php if (has_post_thumbnail()) { ?>
                                                        ...
                                                        <div class="single-course-image">
                                                            ...
                                                            <?php if (!empty($course_price)) { ?>
                                                                <div class="ribbon premium"><?php echo esc_attr($course_price); ?></div><?php } ?>
                        ...
                        <div class="row">
                            ...
                            foreach ($allextraservices as $eservices) {
                                ...
                                if (!empty($page_id)) {
                                    ...
                                    if ($eservicespage->have_posts()) {
                                        while ($eservicespage->have_posts()) {
                                            $eservicespage->the_post();
                                            ?>
                ...
                <section id="service-post-section" class="whysection hs-section">
                    ...
                    <?php if (!empty($aboutbgimg)) { ?>
                        ...
                        <div class="service-left-bg"
                             style="background-image:url(<?php echo esc_url($aboutbgimg); ?>)"></div>
                            ...
                            <div class="service-post-wrap">
                                ...
                                foreach ($allaboutservices as $aservices) {
                                    ...
                                    if (!empty($page_id)) {
                                        ...
                                        if ($whychoose->have_posts()) {
                                            while ($whychoose->have_posts()) {
                                                $whychoose->the_post();
                                                ?>
                                                <div class="service-post clearfix">

                                                    <div class="service-icon"><i
                                                                class="fa <?php echo esc_attr($aservices->about_icon); ?>"></i>
                                                    </div>
                                                    ...
                                                    <div class="service-excerpt">
                                                        ...
                                                        <div class="service-text">
                                                            ...
                                                            <a href="<?php the_permalink(); ?>" class="why-read">
                                                                <?php esc_html_e('Read More', 'education-web'); ?> <i
                    ...
                    <div class="container">
                        ...
                        <div class="row">
                                ...
                                <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                                    ...
                                    foreach ($allfaq as $faq) {
                                        ...
                                        if (!empty($page_id)) {
                                            ...
                                            if ($faqpage->have_posts()) {
                                                while ($faqpage->have_posts()) {
                                                    $faqpage->the_post();
                                                    ?>
                                                    <div class="panel panel-default <?php if ($count == 0) { ?>active<?php } ?>">
                                                        <div class="faq-heading"
                                                             id="FaqTitle<?php echo intval($count); ?>">
                                                            <h4 class="faq-title">
                                                                <a <?php if ($count != 0){ ?>class="collapsed"<?php } ?>
                                                                   data-toggle="collapse" data-parent="#accordion"
                                                                   href="#faq<?php echo intval($count); ?>"><?php the_title(); ?></a>
                                                            </h4>
                                                        </div>
                                                        <div id="faq<?php echo intval($count); ?>"
                                                             class="panel-collapse collapse <?php if ($count == 0) { ?>in<?php } ?>"
                                                             role="tabpanel"
                                                             aria-labelledby="FaqTitle<?php echo intval($count); ?>">
                            ...
                            <?php if (!empty($featuresimg)) { ?>
                                <div class="col-md-5">
                                    <div class="faq-image">
                                        <img src="<?php echo esc_url($featuresimg); ?>"
                                             alt="<?php esc_html_e('Image preview', 'education-web'); ?>">
                                    </div>
                                </div>
                            <?php } ?>
                        </div>
                        ...
                        <div class="row">
                            ...
                            foreach ($allmember as $team) {
                                ...
                                if (!empty($page_id)) {
                                    ...
                                    if ($teampage->have_posts()) {
                                        while ($teampage->have_posts()) {
                                            $teampage->the_post();
                                            ...
                                            <div class="col-md-4 col-sm-6 col-xs-6">
                                                <div class="single-team-item">
                                                    <div class="single-team-img">
                                                        ...
                                                        <div class="team-overlay">
                                                            <div class="team-socila-profile">
                                                                <a target="_blank"
                                                                   href="<?php echo esc_url($team->team_facebook); ?>"><i
                                                                            class="fa fa-facebook"></i></a>
                                                                <a target="_blank"
                                                                   href="<?php echo esc_url($team->team_twitter); ?>"><i
                                                                            class="fa fa-twitter"></i></a>
                                                                <a target="_blank"
                                                                   href="<?php echo esc_url($team->team_instagram); ?>"><i
                                                                            class="fa fa-instagram"></i></a>
                                                                <a target="_blank"
                                                                   href="<?php echo esc_url($team->team_linkedin); ?>"><i
                                                                            class="fa fa-linkedin"></i></a>
                                                                <a target="_blank"
                                                                   href="<?php echo esc_url($team->team_google_plus); ?>"><i
                                                    ...
                                                    <div class="team-desc">
                                                        <h4><?php the_title(); ?>
                                                            <span><?php echo esc_attr($position); ?></span></h4>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                while ($testimonials->have_posts()) {
                                                    ...
                                                    <div class="single-testimonial">
                                                        ...
                                                        <div class="testimonial-info">
                                                            ...
                                                            <?php endif; ?>
                                                            <h6><?php the_title(); ?>
                                                                <span><?php echo esc_attr($compnay); ?></span></h6>
                                                        </div>
                                                    </div>
                                                <?php }
                                            }
                                    ...
                                    while ($query->have_posts()) {
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12 ed-blog-section">
                                            <div class="blog-lists">
                                                <div class="blog-items <?php if (!has_post_thumbnail()) {
                                                    echo esc_attr('nopostimage');
                                                } ?>">
                                            ...
                                            <div class="single-clients">
                                                <a href="<?php echo esc_url($link); ?>" target="_blank">
                                                    <img src="<?php echo esc_url($logo); ?>"
                                                         alt="<?php esc_html_e('Brand Logo Image', 'education-web'); ?>">
                                                </a>
