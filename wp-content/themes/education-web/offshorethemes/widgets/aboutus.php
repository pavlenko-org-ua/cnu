    ...
    class Education_web_aboutus extends WP_Widget {
        ...
        function __construct() {
            ...
            parent::__construct(
                ...
                esc_html__('&bull; AboutUs Widget', 'education-web'),
                            ...
                            <?php } ?>
                                ...
                                <div class="col-md-6 col-sm-12 col-xs-12">
                                    <div class="skill-text">
                                        ...
                                        <?php
                                            $more = ' <a href="'. get_permalink( get_the_ID() ) . '" class="readMoreBtn">'.esc_html__('Continue Reading','education-web').' <i class="fa fa-long-arrow-right"></i></a>';
                                            echo force_balance_tags( html_entity_decode( wp_trim_words( htmlentities( get_the_content() ), 110, $more ) ) );
                                        ?>
                                    </div>
                                </div>
